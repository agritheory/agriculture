	...
	frappe.run_serially([
		...
		() =>
			frappe.tests.make('Crop', [
				...
				{
					materials_required: [
						[{ item_code: 'Basil Seeds' }, { qty: '25' }, { uom: 'Nos' }, { rate: '1' }],
						[{ item_code: 'Urea' }, { qty: '5' }, { uom: 'Kg' }, { rate: '10' }],
					],
				},
				{ byproducts: [[{ item_code: 'Twigs' }, { qty: '25' }, { uom: 'Nos' }, { rate: '1' }]] },
				{ produce: [[{ item_code: 'Basil Leaves' }, { qty: '100' }, { uom: 'Nos' }, { rate: '1' }]] },
				{
					agriculture_task: [
						[
						...
						[{ task_name: 'Final cut' }, { start_day: 15 }, { end_day: 15 }, { holiday_management: 'Ignore holidays' }],
					],
				},
			]),
